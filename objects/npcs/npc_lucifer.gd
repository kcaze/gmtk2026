...
var DIALOGUE = [
	"LUCIFER:[color=#939090] Let me breathe awhile.[/color]",
	"[color=#939090]The stars move still, time runs.[/color]",
	"[color=#939090]One drop of blood, one soul.[/color]",
	"[color=#939090]Go, rein in the night mare.[/color]",
